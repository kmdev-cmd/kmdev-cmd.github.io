...
<strong>Estudante • Desenvolvedor Python • Automação e Backend</strong>
...
## Sobre mim
Sou desenvolvedor focado em **Python** e **automação de processos**.  
Crio ferramentas práticas para reduzir tarefas repetitivas e aumentar produtividade.  
Atualmente aprofundando em **backend com Flask**, banco de dados e boas práticas.  
Aprendo construindo projetos reais e open-source.
...
## Tecnologias
<img src="https://skillicons.dev/icons?i=python,flask,linux,git,github,html,css,js,tailwind,vite,postgresql,supabase&perline=10&theme=dark" />
...
## Especialidades
🐍 **Automação** — Scripts Python para produtividade e sistemas  
⚡ **Web Apps** — Interfaces simples, rápidas e funcionais  
🛠 **Scraping & APIs** — Coleta, tratamento e integração de dados  
